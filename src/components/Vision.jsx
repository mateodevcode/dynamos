  ...
  return (
    ...
    <div className="w-full h-full flex flex-col justify-center bg-imagen-aboutus lg:pt-6 lg:pb-60 sm:pt-20 pb-44">
      ...
      <div className="flex flex-col w-full">
        ...
        <div className="flex flex-row w-full items-center">
          ...
          <div className="flex justify-end w-3/4 lg:mr-10 md:mr-10">
            <Image className="w-7/12 h-4/6" src={vision1} alt="" />
          </div>
        </div>
        {/* recuadro2 */}
        <div className="flex flex-row items-center">
          <div className="flex justify-start w-3/4 lg:ml-10 md:ml-10">
            <Image className="w-6/12" src={vision2} alt="" />
          </div>
          <div className="flex w-1/4"></div>
        </div>
      </div>
      ...
      >
        ...
        <div
          className={`flex flex-col lg:w-[500px] lg:h-[500px] lg:justify-around items-center dark:bg-gray-950 bg-white`}
        >
