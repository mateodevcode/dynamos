import { estilosMision, mision, misionImgs } from "@/data/misionVisionObjetivos";
import Image from "next/image";

function Mision() {
  return (
    <div
      className="flex flex-row justify-center items-center w-full h-full pb-20 pt-10"
      style={estilosMision}
    >
      {/* Mision */}
      <div
