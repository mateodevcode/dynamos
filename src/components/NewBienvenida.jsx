...
const NewBienvenida = () => {
  return (
    ...
    >
      <div className="absolute lg:top-80 md:top-64 sm:top-36 lg:left-32 md:left-32 sm:left-6 flex flex-row justify-center items-center select-none">
      ...
      <div className="lg:h-96 md:h-[360px] md:flex sm:hidden select-none">
