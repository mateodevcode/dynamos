    ...
    <div className="flex flex-col justify-center items-center h-screen dark:bg-gray-950">
      {team ? (
        team.map((valor, i) => {
          return (
            <div
              className={`flex md:max-h-96 md:w-96 rounded-2xl flex-col text-center justify-center items-center sm:max-h-80 sm:w-72 m-4 sm:px-16 sm:py-16 shadow-lg dark:bg-gray-600/50 dark:shadow-white/50 bg-gray-200 shadow-black/50 cursor-pointer select-none`}
              key={i}
            >
