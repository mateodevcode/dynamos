...
import FormCrearTestimonio from "./components/FormCrearTestimonio";
import UpdateTestimonio from "./components/UpdateTestimonio";
  ...
  return (
    <>
      ...
      <div className="lg:w-8/12 md:w-8/12 sm:w-full bg-gray-100 flex flex-col justify-start items-center">
        {!createData && <UpdateTestimonio User={User} Id={Id} />}
        {createData && (
