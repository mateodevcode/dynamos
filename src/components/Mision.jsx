    ...
    <div className={`flex flex-row justify-center items-center w-full h-full bg-imagen-aboutus sm:mb-20`}>
      ...
      sm:w-[600px] sm:pb-10 sm:pt-20 sm:mb-20"
       >
        {/* circulo */}
        <div
          className={`flex flex-col rounded-full items-center lg:w-[600px] lg:h-[600px] lg:-mb-20 md:w-[600px] md:h-[600px] md:-mb-32 sm:w-[320px] sm:h-[320px] sm:-mb-64 dark:bg-gray-950 bg-white`}
        ></div>
        {/* texto */}
        <div className="lg:w-96 lg:-mt-96 lg:mr-24 md:w-96 md:-mt-96 md:mr-24 sm:w-48 sm:-mt-7">
          ...
          <p className="text-gray-400 italic lg:text-sm md:text-sm sm:text-xs font-semibold lg:ml-8 md:ml-20 sm:ml-2">
            @Dynamos_movimiento
          </p>
        </div>
      </div>
